...
import { MacKeyboard, MenuEnum, WinKeyboard } from '/@/enums/editPageEnum';
    ...
    switch (e) {
      ...
      case keyboardValue.up:
        keymaster(
          e,
          throttle(() => {
            editStore.setMove(MenuEnum.ARROW_UP);
            return false;
          }, throttleTime),
        );
        break;
      ...
      case keyboardValue.right:
        keymaster(
          e,
          throttle(() => {
            editStore.setMove(MenuEnum.ARROW_RIGHT);
            return false;
          }, throttleTime),
        );
        break;
      ...
      case keyboardValue.down:
        keymaster(
          e,
          throttle(() => {
            editStore.setMove(MenuEnum.ARROW_DOWN);
            return false;
          }, throttleTime),
        );
        break;
      ...
      case keyboardValue.left:
        keymaster(
          e,
          throttle(() => {
            editStore.setMove(MenuEnum.ARROW_LEFT);
            return false;
          }, throttleTime),
        );
        break;
